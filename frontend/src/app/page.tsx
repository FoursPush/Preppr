...
export default function Home() {
  ...
  return (
    <div className="relative overflow-hidden bg-hero-gradient">
      ...
      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 pb-24 text-center relative z-10">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-500/10 border border-brand-500/20 text-brand-300 text-xs font-semibold uppercase tracking-wider mb-6 animate-pulse-subtle">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          {isLoading ? (
            ...
            <>
              <Link
                href="/dashboard"
                className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-gradient-to-r from-brand-600 to-indigo-600 hover:from-brand-500 hover:to-indigo-500 text-white font-bold text-sm shadow-xl shadow-brand-500/25 transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
              >
                <BarChart3 className="w-4 h-4" /> Go to Candidate Dashboard
              </Link>
              <Link
                href="/interview/setup"
                className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-white/5 hover:bg-white/10 text-white font-semibold text-sm border border-white/10 transition-colors flex items-center justify-center gap-2"
              >
                <Mic className="w-4 h-4 text-brand-400" /> Start Mock Interview <ArrowRight className="w-4 h-4" />
              </Link>
            </>
          ) : (
            /* Not Logged In View - ONLY Get Started and Sign In */
            <>
              <Link
                href="/register"
                className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-gradient-to-r from-brand-600 to-indigo-600 hover:from-brand-500 hover:to-indigo-500 text-white font-bold text-sm shadow-xl shadow-brand-500/25 transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
              ...
              <Link
                ...
                className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-white/5 hover:bg-white/10 text-white font-semibold text-sm border border-white/10 transition-colors flex items-center justify-center gap-2"
              >
                <UserCheck className="w-4 h-4 text-cyan-400" /> Sign In to Existing Account
              </Link>
            </>
          )}
        </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-cyan-500/40 transition-all backdrop-blur-sm group">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Acoustic Telemetry</h3>
            <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-amber-500/40 transition-all backdrop-blur-sm group">
            ...
            <h3 className="text-lg font-bold text-white mb-2">LLM-as-a-Judge Rubric</h3>
            <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 opacity-75">
            <span className="text-base sm:text-lg font-bold text-gray-300">Amazon (Leadership Principles)</span>
            <span className="text-base sm:text-lg font-bold text-gray-300">Google (System Design)</span>
            <span className="text-base sm:text-lg font-bold text-gray-300">Meta (Coding & Architecture)</span>
            <span className="text-base sm:text-lg font-bold text-gray-300">Tech Startups</span>
          </div>
        </div>
      </section>
    </div>
